...
export function DictionaryGenerator() {
  ...
  const generateDictionary = () => {
    ...
    router.push({
      pathname: '/tester',
      params: { dictionary: JSON.stringify(dictionary) },
    });
  };
    ...
    <ThemedView style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <TextInput
          ...
          onChangeText={(text) =>
            setCurrentField({ ...currentField, key: text })
          }
          style={styles.input}
        ...
        <TextInput
          ...
          onChangeText={(text) =>
            setCurrentField({ ...currentField, value: text })
          }
          style={styles.input}
          placeholderTextColor="#666"
        />
      ...
      <View style={styles.optionsContainer}>
        <View style={styles.optionRow}>
          <Switch value={useSpecialChars} onValueChange={setUseSpecialChars} />
        ...
        <View style={styles.optionRow}>
          <Switch value={useLeetSpeak} onValueChange={setUseLeetSpeak} />
      ...
      <TouchableOpacity
        ...
        style={[
          ...
          fields.length < 2 && styles.generateButtonDisabled,
        ]}
